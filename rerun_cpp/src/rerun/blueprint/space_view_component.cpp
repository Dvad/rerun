...
namespace rerun::blueprint {
    const std::shared_ptr<arrow::DataType>& SpaceViewComponent::arrow_datatype() {
        static const auto datatype = arrow::struct_({
            ...
            arrow::field("space_origin", rerun::datatypes::EntityPath::arrow_datatype(), false),
            arrow::field("entities_determined_by_user", arrow::boolean(), false),
            arrow::field(
                "contents",
                arrow::list(arrow::field("item", rerun::datatypes::Uuid::arrow_datatype(), false)),
                false
            ),
        });
        return datatype;
    ...
    rerun::Error SpaceViewComponent::fill_arrow_array_builder(
        ...
        }
        {
            ...
            ARROW_RETURN_NOT_OK(field_builder->Reserve(static_cast<int64_t>(num_elements)));
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                RR_RETURN_NOT_OK(rerun::datatypes::EntityPath::fill_arrow_array_builder(
                    field_builder,
        ...
        }
        {
            ...
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                ...
                if (element.contents.data()) {
                    RR_RETURN_NOT_OK(rerun::datatypes::Uuid::fill_arrow_array_builder(
                        value_builder,
